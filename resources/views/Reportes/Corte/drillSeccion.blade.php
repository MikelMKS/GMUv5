...
<div class="modal-header">
    <h4 class="modal-title col-12 text-center"><strong class="titulomodal">{{$seccion}}</strong><br><span class="titulomodal">{{$inicio}} / {{$fin}}</span><br><span class="subtitulomodal">{{$cliente}}</span></h4>
</div>
{{--  --}}
        ...
        <table id="tablaSeccion" class="styled-table" style="width:100%">
            <thead>
                ...
                <tr>
                    ...
                    <th class="col" style="width: 5% !important;">TIPO</th>
                    <th class="col" style="width: 40% !important;">OBSERVACION</th>
                    <th class="col" style="width: 20% !important;">IMPORTE</th>
                    <th class="col" style="width: 20% !important;">PENDIENTE</th>
                </tr>
            </thead>
            <tbody>
                @php $numero = 1; @endphp
